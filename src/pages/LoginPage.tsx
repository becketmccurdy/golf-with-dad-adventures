...
const LoginPage: React.FC = () => {
  ...
  <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-emerald-600 to-emerald-700 p-12 flex-col justify-between text-white relative overflow-hidden">
        ...
        <div className="flex-1 lg:w-1/2 flex items-center justify-center p-4 lg:p-8">
          <div className="w-full max-w-md">
            ...
            <div className="lg:hidden text-center mb-8">
              ...
              <h1 className="text-3xl font-extrabold text-gray-900 tracking-tight">Golf with Dad</h1>
              <p className="text-gray-600 mt-1">Track your golf adventures</p>
            </div>

            {/* Login Card */}
            <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-5 lg:p-7 relative" role="region" aria-label="Sign in panel">
              {/* Decorative element */}
              ...
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600 text-sm">Sign in to continue your golf journey</p>
              </div>
              ...
              <Button onClick={handleGoogleSignIn} disabled={isLoading} isLoading={isLoading} fullWidth aria-label="Sign in with Google" className="mb-3 py-3">
              ...
              {/* Divider */}
              <div className="flex items-center my-3" role="separator" aria-label="or continue with phone">
                <div className="flex-1 h-px bg-stone-200" />
                <span className="px-3 text-[11px] uppercase tracking-wider text-stone-400">or</span>
                <div className="flex-1 h-px bg-stone-200" />
              </div>
              ...
              <div className="space-y-3" aria-label="Phone sign in">
                ...
                <Button type="button" variant="secondary" isLoading={isSending} onClick={handleSendCode} fullWidth className="py-2.5">
                ...
                {verificationId && (
                  <div className="space-y-3">
                    ...
                    />
                    <Button type="button" isLoading={isVerifying} onClick={handleVerifyCode} fullWidth className="py-2.5">
                      Verify and continue
                    </Button>
